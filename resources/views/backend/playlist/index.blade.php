...
@section('content')
    <div class="card">
      <div class="card-header">
        <i class="icon-directions"></i> Playlist
          ...
          <tbody>
              @if($rows )
                ...
                <tr>                    
                    ...
                    @endforeach
                    <td class="action">
                        <a title="Add video" class="text-dark" href="{{ url('backend/playlist/'. $row->id ) }}"><i class="icon-film"></i>
...
@endsection
@section('modal')
    @include('backend.playlist.modal-form')
@endsection

@section('javascript')
    <script src="{{ asset('public/build/backend/js/playlist-index.js') }}"></script>
@endsection